...
*/
public class IntegerSimpleHashFunction implements HashFunction<IntegerData> {
    private int cellCount;
    private int hashFunctionCount;

    public IntegerSimpleHashFunction(int cellCount, int hashFunctionCount) {
    ...
    public int hash(int hashFunctionNumber, IntegerData data) {
        ...
        int result = data.getValue() + hashFunctionNumber;
